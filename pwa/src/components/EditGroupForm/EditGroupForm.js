...
const EditGroupForm = () => {
    ...
    const handleSubmit = (e) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        if (currentGroup) {
            dispatch((0, catalogue_1.updateGroup)({ id: currentGroup.id, name }));
        }
    });
    return (react_1.default.createElement("form", { className: Form_scss_1.default.Container, onSubmit: handleSubmit },
        react_1.default.createElement("h1", { className: Form_scss_1.default.Title }, "\u0418\u0437\u043C\u0435\u043D\u0438\u0442\u044C \u0433\u0440\u0443\u043F\u043F\u0443"),
...
exports.EditGroupForm = EditGroupForm;
