...
exports.EditSubcategoryForm = void 0;
...
const specificationParser_1 = require("@utils/specificationParser");
...
const EditSubcategoryForm = () => {
    ...
    react_1.default.useEffect(() => {
        if (currentSubcategory) {
            ...
            dispatchSpecification({
                type: 'set',
                payload: (0, specificationParser_1.prefillSubcategorySpecifications)(currentSubcategory.specifications),
            });
        }
    }, []);
    ...
    const handleSubmit = (e) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        if (currentSubcategory) {
            dispatch((0, catalogue_1.updateSubcategory)({
                id: currentSubcategory.id,
                data: { name, specifications: (0, specificationParser_1.stripSpecifications)(specifications) },
            }));
        }
    });
    return (react_1.default.createElement("form", { className: Form_scss_1.default.Container, onSubmit: handleSubmit },
        react_1.default.createElement("h1", { className: Form_scss_1.default.Title }, "\u041F\u0440\u0430\u0432\u0438\u0442\u044C \u043F\u043E\u0434\u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E"),
...
exports.EditSubcategoryForm = EditSubcategoryForm;
