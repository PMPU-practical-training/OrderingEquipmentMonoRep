...
exports.EditProductForm = exports.productSpecificationsReducer = void 0;
...
const EditProductForm = () => {
                        ...
                        switch (specification.type) {
                            case Specification_1.SpecificationType.Radio:
                                return {
                                    ...
                                    categorySpecification: currentSubcategory.specifications.find(subcategorySpecification => subcategorySpecification.id === specification.id),
                                    key: (0, uuid_1.v4)(),
                                    error: '',
                                };
    ...
    const handleSubmit = (e) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        const parsedProductSpecifications = productSpecifications.map(productSpecification => {
            ...
            switch (categorySpecification.type) {
                case Specification_1.SpecificationType.Select:
                    ...
                    console.log(productSpecification.values);
                    return {
                ...
                case Specification_1.SpecificationType.Range:
                    console.log(productSpecification.rangeValue);
                    return {
                        id: categorySpecification.id,
                        name: categorySpecification.name,
                        type: categorySpecification.type,
        ...
        if (currentGroup && currentCategory && currentSubcategory && product) {
            console.log({
                ...
                body: {
                    name,
                    price: Object.assign(Object.assign({}, product.price), { rangeValue: Object.assign(Object.assign({}, product.price.rangeValue), { value: parseFloat(price) }) }),
                    specifications: parsedProductSpecifications,
                },
            });
            dispatch((0, product_1.updateProduct)({
                categoryId: currentCategory.id,
                subcategoryId: currentSubcategory.id,
                productId: product.id,
                body: {
    ...
    return (react_1.default.createElement("form", { className: Form_scss_1.default.Container, onSubmit: handleSubmit },
        react_1.default.createElement("h1", { className: Form_scss_1.default.Title }, "\u041F\u0440\u0430\u0432\u0438\u0442\u044C \u043F\u043E\u0437\u0438\u0446\u0438\u044E"),
        ...
        react_1.default.createElement("div", { className: Form_scss_1.default.Item },
            ...
            react_1.default.createElement("div", { className: Form_scss_1.default.Multipart },
                ...
                unusedSpecifications.length !== 0 && (react_1.default.createElement(Button_1.default, { style: { width: '40px', padding: '0' }, theme: Button_1.ButtonThemeIcn.White, onClick: addProductSpecification, icon: icons_1.IconName.AddField })))),
        react_1.default.createElement(Button_2.default, { className: Form_scss_1.default.Submit, name: "\u041E\u0431\u043D\u043E\u0432\u0438\u0442\u044C", type: "submit", theme: Button_2.ButtonTheme.Dark })));
};
